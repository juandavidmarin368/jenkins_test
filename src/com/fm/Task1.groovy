...
class Task1 implements Serializable{
    ...
    Map testingIssue(){
        ...
        String stringPhrase = "Nessus was unable to log into the following host for which"
         ...
         String script ="""
                #!/bin/bash
                /usr/local/bin/docker run -v /Users/david/Documents/tmp_jenkins_test_library:/data -e fileName="dev-distributed_xlh25e.pdf" -e stringPhrase="${stringPhrase}" vi-nexus.lab.vi.local/scan-nessus-python-pdfparser:v1
          """
